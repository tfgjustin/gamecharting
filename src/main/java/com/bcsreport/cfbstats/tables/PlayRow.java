...
public class PlayRow implements Comparable {
  ...
  public boolean equals(Object o) {
    if (o instanceof PlayRow) {
      ...
      return this.gameCode.equals(here.gameCode) && this.playNum == here.playNum;
    }
    return false;
  }
  ...
  public static enum PlayType {
    ATTEMPT, FIELD_GOAL, KICKOFF, PASS, PENALTY, PUNT, RUSH, TIMEOUT, ;
  }
