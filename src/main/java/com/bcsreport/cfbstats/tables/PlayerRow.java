...
public class PlayerRow implements Comparable {
  ...
  public boolean equals(Object o) {
    if (o instanceof PlayerRow) {
      ...
      return this.teamCode == here.teamCode && this.playerCode == here.playerCode;
    }
    return false;
  }
  ...
  static enum Position {
    ATH, C, CB, DB, DE, DL, DS, DT, FB, FL, FS, HB, HOLD, ILB, K, LB, LS, MLB, NG, NT, OG, OL, OLB, OT, P, PK, QB, RB, ROV, S, SB, SE, SN, SS, TB, TE, WR, TEAM, UNKNOWN, ;
