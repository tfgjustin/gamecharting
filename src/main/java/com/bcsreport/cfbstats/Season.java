...
public class Season {
  ...
  public static Season makeSeason(File dir) throws IOException {
    ...
    season.setPlayerGameStatsTable(PlayerGameStatsTable.loadTable(new File(dir,
    ...
    season.setTeamGameStatsTable(TeamGameStatsTable.loadTable(new File(dir,
        "team-game-statistics.csv")));
    season.setTeamTable(TeamTable.loadTable(new File(dir, "team.csv")));
    long endTimeMillis = System.currentTimeMillis();
    endTimeMillis -= startTimeMillis;
    System.out.println("Loaded season data in " + endTimeMillis + " msec");
    return season;
  }
